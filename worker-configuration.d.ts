/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 176a1e1cfbc6e0e784c2444dbe06eb75)
// Runtime types generated with workerd@1.20260405.1 2024-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "SessionStore";
	}
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
